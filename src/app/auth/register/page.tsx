...
import { EnvelopeIcon, KeyIcon, UserIcon, LockClosedIcon } from '@heroicons/react/24/outline'
          ...
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="flex-1">
              ...
              <form className="mt-6 space-y-6" onSubmit={handleSubmit(onSubmit)}>
                <div>
                  <label htmlFor="name" className="block text-sm font-medium leading-6 text-accent-silver">
                    Full name
                  </label>
                ...
                <div>
                  <label htmlFor="confirm-password" className="block text-sm font-medium leading-6 text-accent-silver">
                    Confirm password
                  </label>
                  <div className="mt-2 relative">
                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                      <KeyIcon className="h-5 w-5 text-black" aria-hidden="true" />
                    </div>
                    <input
                ...
                <div className="flex items-center relative z-20">
                  <input
                    ...
                    name="terms"
                    type="checkbox"
                    className="h-4 w-4 rounded border-accent-silver/10 bg-white text-accent-neon focus:ring-accent-neon cursor-pointer focus:ring-offset-0 focus:ring-1 relative z-20"
                  />
                  <label htmlFor="terms" className="ml-3 block text-sm leading-6 text-accent-silver cursor-pointer select-none">
                    I agree to the{' '}
                    <Link href="/terms" className="font-semibold text-accent-neon hover:text-white transition-colors relative z-20">
